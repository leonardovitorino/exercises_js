...
const fourString = firstFourStrings.join(', ').replace(`, ${lastItem}`, ` e ${lastItem}`)
...
switch(drinkType) {
  case 'Água':
    ...
    break
  case 'Refrigerante':
    console.log('Bebida não alcoólica e não fermentada, fabricada industrialmente, à base de água e mineral e açucar.')
    break
  case 'Suco':
