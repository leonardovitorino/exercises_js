...
const fruits = ['morango', 'abacaxi', 'mamão']
...
console.log(`O crazyArray tem ${booleanAmount} booleans, ${numberAmount} numeros e ${stringAmount} strings.`)
...
console.log(`Números ímpares: ${evenNumberString}. Números pares: ${oddNumberString}.`)